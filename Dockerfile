...
RUN export DEBIAN_FRONTEND=noninteractive \
    ...
    && apt-get update -y \
    && apt-get install -y curl jq locales git python-is-python3 build-essential libpq-dev python3 python3-dev python3-pip python3-wheel python3-setuptools python3-psycopg2 python3-virtualenv \
...
RUN pip3 install virtualenv && virtualenv --python=python3 venv && source venv/bin/activate && pip install pyyaml && python env/common_config/add_imagepullsecret.py
